...
sudo python3 gpu_fans.py 70           # all GPUs
sudo python3 gpu_fans.py 70 --gpu 0   # GPU 0 only
sudo python3 gpu_fans.py 70 --gpu 0,1 # GPUs 0 and 1
sudo python3 gpu_fans.py auto         # hand control back to driver
"""
import argparse
import sys
from pynvml import (
